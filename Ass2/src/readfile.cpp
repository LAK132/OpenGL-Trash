...
// Please fill in parts that say YOUR CODE FOR Assignment 2 HERE. 
            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                if (cmd == "light") {
                    if (numused == numLights) { // No more Lights 
                        ...
                        if (validinput) {
                            ...
                            size_t lightNum = numused * 4;
                            lightposn[lightNum] =   values[0];
                            lightposn[lightNum+1] = values[1];
                            lightposn[lightNum+2] = values[2];
                            lightposn[lightNum+3] = values[3];
                            lightcolor[lightNum] =  values[4];
                            lightcolor[lightNum+1] = values[5];
                            lightcolor[lightNum+2] = values[6];
                            lightcolor[lightNum+3] = values[7];
                ...
                // Note that no transforms/stacks are applied to the colors. 
                    ...
                    if (validinput) {
                        ...
                        // YOUR CODE FOR Assignemnt 2 HERE
                ...
                // Left the code for loading objects in the skeleton, so 
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
                        ...
                        rightmultiply(mat4(Transform::rotate(values[3], {values[0], values[1], values[2]})), transfstack);
                    }
                }
